...
/* harmony import */ var _components_image_credit_image_credit__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./components/image-credit/image-credit */ "./src/components/image-credit/image-credit.js");
...
function prepareLinks(widget, headings) {
  ...
  function getParentSessionID() {
    var accordionID = jquery__WEBPACK_IMPORTED_MODULE_5___default()(widget).attr('id');
    var sessionID;

    if (typeof accordionID == 'undefined') {
      sessionID = 'parent-anchor-data-id';
    } else {
      sessionID = 'parent-anchor-data-id-' + accordionID;
    }
  ...
  parentAccordionTab.on('click', function () {
    // ID of selected tab
    var selectedTab = jquery__WEBPACK_IMPORTED_MODULE_5___default()(this).attr('data-id');
    var parentSessionID = getParentSessionID(); // Store selected tab data ID in session storage

    sessionStorage.setItem(parentSessionID, selectedTab);
  ...
  var parentSessionID = getParentSessionID(); // Get selected anchor 'data-id' from session storage

  var sessionParentAnchorId = sessionStorage.getItem(parentSessionID);
