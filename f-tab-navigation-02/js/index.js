...
/* harmony import */ var _components_url_dropdown_url_dropdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/url-dropdown/url-dropdown */ "./src/components/url-dropdown/url-dropdown.js");
/* harmony import */ var _components_url_slide_url_slide__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/url-slide/url-slide */ "./src/components/url-slide/url-slide.js");
/* harmony import */ var _components_video_preview_video_preview__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/video-preview/video-preview */ "./src/components/video-preview/video-preview.js");
/* harmony import */ var _components_nav_mobile__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/nav-mobile */ "./src/components/nav-mobile/index.js");
/* harmony import */ var _components_site_search__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/site-search */ "./src/components/site-search/index.js");
/* harmony import */ var _components_accordion_tabs_accordion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/accordion-tabs/accordion */ "./src/components/accordion-tabs/accordion.js");
/* harmony import */ var _components_accordion_tabs_accordion_tabs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/accordion-tabs/accordion-tabs */ "./src/components/accordion-tabs/accordion-tabs.js");
/* harmony import */ var _components_accordion_tabs_tabs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/accordion-tabs/tabs */ "./src/components/accordion-tabs/tabs.js");
/* harmony import */ var _components_popup_def_list_group_popup_def_list_group__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/popup-def-list-group/popup-def-list-group */ "./src/components/popup-def-list-group/popup-def-list-group.js");
/* harmony import */ var _components_kis_widget_kis_widget__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/kis-widget/kis-widget */ "./src/components/kis-widget/kis-widget.js");
/* harmony import */ var _components_primary_dropdown_primary_dropdown__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/primary-dropdown/primary-dropdown */ "./src/components/primary-dropdown/primary-dropdown.js");
/* harmony import */ var _components_feature_news_feature_news__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/feature-news/feature-news */ "./src/components/feature-news/feature-news.js");
/* harmony import */ var _components_feature_news_feature_news__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_components_feature_news_feature_news__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _components_scroll_animations__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/scroll-animations */ "./src/components/scroll-animations/index.js");
/* harmony import */ var _components_action_on_scroll__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/action-on-scroll */ "./src/components/action-on-scroll.js");
/* harmony import */ var _components_video_banner_video_banner__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/video-banner/video-banner */ "./src/components/video-banner/video-banner.js");
...
/* harmony import */ var _components_soundwave_bg_soundwave_bg__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./components/soundwave-bg/soundwave-bg */ "./src/components/soundwave-bg/soundwave-bg.js");
/* harmony import */ var _components_carousel_carousel__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./components/carousel/carousel */ "./src/components/carousel/carousel.js");
...
function launch(el, i) {
  ...
  var menu = Object(_common_prepare_menu__WEBPACK_IMPORTED_MODULE_3__["default"])(className, widget, i, headings, contentWrapper, true);
...
var contentCn = function contentCn(className) {
  return "".concat(className, "__content");
};
var contentGroupCn = function contentGroupCn(className) {
  return "".concat(contentCn(className), "__group");
};
var headingCn = function headingCn(className) {
  return "".concat(contentCn(className), "__heading");
};
var headingAnchorCn = function headingAnchorCn(className) {
  return "".concat(contentCn(className), "__heading-anchor");
};
var headingAnchorLabelCn = function headingAnchorLabelCn(className) {
  return "".concat(headingAnchorCn(className), "__label");
};
var headingAnchorIconCn = function headingAnchorIconCn(className) {
  return "".concat(headingAnchorCn(className), "__icon");
};
var menuCn = function menuCn(className) {
  return "".concat(className, "__menu");
};
var menuWrapperCn = function menuWrapperCn(className) {
  return "".concat(menuCn(className), "-wrapper");
};
var menuItemCn = function menuItemCn(className) {
  return "".concat(menuCn(className), "__item");
};
var menuItemLabelCn = function menuItemLabelCn(className) {
  return "".concat(menuItemCn(className), "__label");
};

/***/ }),

/***/ "./src/components/accordion-tabs/common/nested-accordions.js":
/*!*******************************************************************!*\
  !*** ./src/components/accordion-tabs/common/nested-accordions.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
var nestedAccordions = function nestedAccordions() {
  ...
  if (sessionNestedAccordionId) {
    var nestedAnchors = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".accordion-tabs__content__group:eq(".concat(sessionParentAnchorId, ") a.accordion__content__heading-anchor"));
...
/* harmony default export */ __webpack_exports__["default"] = (nestedAccordions);

/***/ }),

/***/ "./src/components/accordion-tabs/common/nested-tabs.js":
/*!*************************************************************!*\
  !*** ./src/components/accordion-tabs/common/nested-tabs.js ***!
  \*************************************************************/
/*! exports provided: default */
...
var nestedTabs = function nestedTabs() {
  var sessionParentAnchorId = sessionStorage.getItem('parent-anchor-data-id');
  var sessionNestedTabId = sessionStorage.getItem('nested-tab-data-id');

  if (sessionNestedTabId) {
    var nestedTabAnchors = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".accordion-tabs__content__group:eq(".concat(sessionParentAnchorId, ") a.tabs__menu__item"));
...
/* harmony default export */ __webpack_exports__["default"] = (nestedTabs);

/***/ }),

/***/ "./src/components/accordion-tabs/common/parent-anchor-class.js":
/*!*********************************************************************!*\
  !*** ./src/components/accordion-tabs/common/parent-anchor-class.js ***!
  \*********************************************************************/
/*! exports provided: default */
...
var setParentAnchorClass = function setParentAnchorClass() {
  var sessionParentAnchorId = sessionStorage.getItem('parent-anchor-data-id');
...
/* harmony default export */ __webpack_exports__["default"] = (setParentAnchorClass);

/***/ }),

/***/ "./src/components/accordion-tabs/common/parent-tab-clicks.js":
/*!*******************************************************************!*\
  !*** ./src/components/accordion-tabs/common/parent-tab-clicks.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
var parentTabClick = function parentTabClick(newAnchorDataId) {
  var sessionParentAnchorId = sessionStorage.getItem('parent-anchor-data-id');
  var tabFirstAnchor = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.accordion-tabs__menu__item:eq(0)');
  var tabNotFirstAnchor = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.accordion-tabs__menu__item:not(:eq(0))');
  var firstAnchorContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.accordion-tabs__content .accordion-tabs__content__group:eq(0)');
  var notfirstAnchorContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.accordion-tabs__content .accordion-tabs__content__group:not(:eq(0))'); // If sessionParentAnchorId value is 0, show this content
  ...
  // let newAnchorDataId = $(this).attr('data-id');
  ...
  if (newAnchorDataId == '0') {
    ...
    // Content behaviour
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".accordion-tabs__content .accordion-tabs__content__group:eq(".concat(newAnchorDataId, ")")).css('display', 'block');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".accordion-tabs__content .accordion-tabs__content__group:not(:eq(".concat(newAnchorDataId, "))")).css('display', 'none'); // Menu heading behaviour

    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".accordion-tabs__menu__item:eq(".concat(newAnchorDataId, ")")).attr({
      'aria-selected': 'true',
      'aria-expanded': 'true'
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".accordion-tabs__menu__item:not(:eq(".concat(newAnchorDataId, "))")).attr({
      'aria-selected': 'false',
      'aria-expanded': 'false'
    });
...
/* harmony default export */ __webpack_exports__["default"] = (parentTabClick);
...
/* harmony import */ var _prepare_tab_links__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./prepare-tab-links */ "./src/components/accordion-tabs/common/prepare-tab-links.js");
...
function prepareLinks(widget, headings) {
  ...
  Object(_prepare_tab_links__WEBPACK_IMPORTED_MODULE_5__["default"])();
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _element_classnames__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./element-classnames */ "./src/components/accordion-tabs/common/element-classnames.js");
...
/* harmony import */ var _js_utils_browser_support__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../js-utils/browser-support */ "./src/js-utils/browser-support.js");
...
function prepareTabsHeadings(className, widget, i, headings, content, sticky) {
  var tabsBar = jquery__WEBPACK_IMPORTED_MODULE_1___default()('<div></div>').addClass(Object(_element_classnames__WEBPACK_IMPORTED_MODULE_2__["menuCn"])(className));
  headings.forEach(function (_ref) {
    var text = _ref.text,
        id = _ref.id;
    var anchor = jquery__WEBPACK_IMPORTED_MODULE_1___default()('<a href="#"></a>').addClass(Object(_element_classnames__WEBPACK_IMPORTED_MODULE_2__["menuItemCn"])(className)).addClass('inactive').attr('data-id', id);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('<span></span>').addClass(Object(_element_classnames__WEBPACK_IMPORTED_MODULE_2__["menuItemLabelCn"])(className)).html(text).appendTo(anchor);
    anchor.appendTo(tabsBar);
  });
  var wrapper = jquery__WEBPACK_IMPORTED_MODULE_1___default()('<div></div>').addClass(Object(_element_classnames__WEBPACK_IMPORTED_MODULE_2__["menuWrapperCn"])(className)).append(tabsBar);
  var containerClass = "".concat(Object(_element_classnames__WEBPACK_IMPORTED_MODULE_2__["menuCn"])(className), "-fullwidth");
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('<div></div>').addClass(containerClass).append(wrapper).insertBefore(content);

  if (sticky && _js_utils_browser_support__WEBPACK_IMPORTED_MODULE_4__["default"].csspositionsticky) {
    Object(stickybits__WEBPACK_IMPORTED_MODULE_3__["default"])(".".concat(containerClass), {
...
function findHeadings(className, widget, contentWrapper) {
  ...
  return headerElements.toArray().map(function (element, i) {
    ...
    if (!wrapper) {
      ...
      wrapper = jquery__WEBPACK_IMPORTED_MODULE_1___default()('<div></div>').insertBefore(header).append(header).append(contentElements);
    }
...
/***/ "./src/components/accordion-tabs/common/prepare-tab-links.js":
/*!*******************************************************************!*\
  !*** ./src/components/accordion-tabs/common/prepare-tab-links.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _session_variables__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./session-variables */ "./src/components/accordion-tabs/common/session-variables.js");
/* harmony import */ var _parent_anchor_class__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parent-anchor-class */ "./src/components/accordion-tabs/common/parent-anchor-class.js");
/* harmony import */ var _parent_tab_clicks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./parent-tab-clicks */ "./src/components/accordion-tabs/common/parent-tab-clicks.js");
/* harmony import */ var _nested_accordions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./nested-accordions */ "./src/components/accordion-tabs/common/nested-accordions.js");
/* harmony import */ var _nested_tabs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./nested-tabs */ "./src/components/accordion-tabs/common/nested-tabs.js");
...
function parentTabLinks() {
  /***** SESSION ANCHOR VALUES *****/
  // Capture top-level tab anchor click ID
  var parentAccordionTab = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs--top-level-layout .accordion-tabs__content .accordion-tabs__content__heading-anchor, .accordion-tabs__menu-fullwidth .accordion-tabs__menu-wrapper .accordion-tabs__menu a');
  parentAccordionTab.on('click', function () {
    // ID of selected tab
    var selectedTab = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('data-id'); // Store selected tab data ID in session storage

    sessionStorage.setItem('parent-anchor-data-id', selectedTab);
  }); // Capture selected nested accordion data-id

  var nestedAccordion = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs__content .accordion__content__heading-anchor');
  nestedAccordion.on('click', function () {
    var selectedNestedAnchor = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('data-id');
    sessionStorage.setItem('nested-accordion-data-id', selectedNestedAnchor);
  }); // Capture selected nested tab data-id

  var nestedTab = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs__content .tabs__menu__item');
  nestedTab.on('click', function () {
    var selectedNestedTab = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('data-id');
    sessionStorage.setItem('nested-tab-data-id', selectedNestedTab);
  }); // Get selected anchor 'data-id' from session storage

  var sessionParentAnchorId = sessionStorage.getItem('parent-anchor-data-id'); // let sessionNestedAccordionId = sessionStorage.getItem('nested-accordion-data-id');
  ...
  if (sessionParentAnchorId) {
    /***** SELECTOR VARIABLES *****/
    // Tab anchors
    var tabFirstAnchor = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs__menu__item:eq(0)');
    var tabNotFirstAnchor = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs__menu__item:not(:eq(0))'); // Accordion anchors

    var accordionFirstAnchor = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs__content__heading-anchor:eq(0)');
    var accordionNotFirstAnchor = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs__content__heading-anchor:not(:eq(0))'); // Accordion and tab anchors

    var firstAnchorContent = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs__content .accordion-tabs__content__group:eq(0)');
    var notfirstAnchorContent = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs__content .accordion-tabs__content__group:not(:eq(0))'); // New anchor clicks

    var newAnchorDataId;
    /***** END SELECTOR VARIABLES *****/
    // Accordion and tab => set parent element class set on current session activity

    Object(_parent_anchor_class__WEBPACK_IMPORTED_MODULE_3__["default"])(); // Desktop => parent tab menu interaction 

    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs__menu__item').click(function () {
      var newAnchorDataId = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('data-id');
      Object(_parent_tab_clicks__WEBPACK_IMPORTED_MODULE_4__["default"])(newAnchorDataId);
    }); // Nested accordions behaviour

    Object(_nested_accordions__WEBPACK_IMPORTED_MODULE_5__["default"])(); // Nested tabs behaviour

    Object(_nested_tabs__WEBPACK_IMPORTED_MODULE_6__["default"])(); //
    ...
    [].forEach.call(matchingIds, function (elem) {
      ...
      if (parent == 'accordion-tabs__content') {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_1___default()('.accordion-tabs__content__heading-anchor').click(function () {
          newAnchorDataId = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('data-id');
          /***** MOBILE *****/

          if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('aria-selected') == 'true') {
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('aria-selected', 'false');
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('aria-expanded', 'false');
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('class', 'accordion-tabs__content__heading-anchor active');
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(".accordion-tabs__content .accordion-tabs__content__group:eq(".concat(newAnchorDataId, ")")).css('dislay', 'none');
          } else if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('aria-selected') == 'false') {
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('aria-selected', 'true');
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('aria-expanded', 'true');
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(".accordion-tabs__content .accordion-tabs__content__group:eq(".concat(newAnchorDataId, ")")).css('dislay', 'block');
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('class', 'accordion-tabs__content__heading-anchor inactive');
          }

          if (newAnchorDataId == sessionParentAnchorId && jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('aria-expanded') == 'true') {
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('aria-selected', 'false');
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('aria-expanded', 'false');
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('class', 'accordion-tabs__content__heading-anchor inactive');
            ;
          ...
          if (newAnchorDataId != sessionParentAnchorId) {
            jquery__WEBPACK_IMPORTED_MODULE_1___default()(".accordion-tabs__content .accordion-tabs__content__heading-anchor:eq(".concat(sessionParentAnchorId, ")")).attr({
              'aria-expanded': 'false',
              'aria-selected': 'false',
          ...
          if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('data-id') == '0' && jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).attr('aria-selected') == 'true') {
            firstAnchorContent.show();
...
/* harmony default export */ __webpack_exports__["default"] = (parentTabLinks);

/***/ }),

/***/ "./src/components/accordion-tabs/common/session-variables.js":
/*!*******************************************************************!*\
  !*** ./src/components/accordion-tabs/common/session-variables.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
function sessionVars() {
  // Capture top-level tab anchor click ID
  var parentAccordionTab = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.accordion-tabs--top-level-layout .accordion-tabs__content .accordion-tabs__content__heading-anchor, .accordion-tabs__menu-fullwidth .accordion-tabs__menu-wrapper .accordion-tabs__menu a');
  parentAccordionTab.on('click', function () {
    // ID of selected tab
    var selectedTab = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('data-id'); // Store selected tab data ID in session storage

    sessionStorage.setItem('parent-anchor-data-id', selectedTab);
  }); // Capture selected nested accordion data-id

  var nestedAccordion = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.accordion-tabs__content .accordion__content__heading-anchor');
  nestedAccordion.on('click', function () {
    var selectedNestedAnchor = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('data-id');
    sessionStorage.setItem('nested-accordion-data-id', selectedNestedAnchor);
  }); // Capture selected nested tab data-id

  var nestedTab = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.accordion-tabs__content .tabs__menu__item');
  nestedTab.on('click', function () {
    var selectedNestedTab = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('data-id');
    sessionStorage.setItem('nested-tab-data-id', selectedNestedTab);
  });
}

/* harmony default export */ __webpack_exports__["default"] = (sessionVars);
...
function launch(el, i) {
  ...
  var contentWrapper = Object(_common_prepare_content__WEBPACK_IMPORTED_MODULE_2__["default"])(className, widget);
  var headings = Object(_common_prepare_sections__WEBPACK_IMPORTED_MODULE_1__["default"])(className, widget, contentWrapper);
  var menu = Object(_common_prepare_menu__WEBPACK_IMPORTED_MODULE_3__["default"])(className, widget, i, headings, contentWrapper, false);
  Object(_common_prepare_links__WEBPACK_IMPORTED_MODULE_4__["default"])(widget, headings, menu, headings.length > 0 && headings[0].id);
}
...
function actionOnScroll(element, action) {
  ...
  if (element && element.length > 0) {
    // normalise element
    if (element instanceof jquery__WEBPACK_IMPORTED_MODULE_1___default.a) {
      element = element[0];
...
function launch(el) {
  var ghostButtons = jquery__WEBPACK_IMPORTED_MODULE_3___default()(el);
...
function launch(el) {
  ...
  link.each(function () {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).click(function (e) {
      e.preventDefault();
      var buttonID = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).data('button');
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('div[data-card = "' + buttonID + '"]').each(function () {
        if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).hasClass('active')) {
          return true;
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('div.active').removeClass('active');
          jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass('active');
        }
      });
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('a[data-button = "' + buttonID + '"]').each(function () {
        if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).hasClass('active')) {
          return true;
        } else {
          jquery__WEBPACK_IMPORTED_MODULE_1___default()('a.active').removeClass('active');
          jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass('active');
...
function launch(el) {
  ...
  if (!js_cookie__WEBPACK_IMPORTED_MODULE_2___default.a.get(COOKIE_NAME)) {
    js_cookie__WEBPACK_IMPORTED_MODULE_2___default.a.set(COOKIE_NAME, '1', {
      expires: 365
    });
    widget.show();
...
function openModalDialog(title, content) {
  ...
  closeDialog(false);
  var finalOptions = extend__WEBPACK_IMPORTED_MODULE_1___default()({}, DEFAULT_OPTS, opts);

  if (finalOptions.identifyFocusBackTo) {
    current.focusBackTo = jquery__WEBPACK_IMPORTED_MODULE_0___default()(':focus');
  }

  var dlg = current.dlg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>').addClass('dialog').attr('tabindex', '0').appendTo(jquery__WEBPACK_IMPORTED_MODULE_0___default()('body'));
  ...
  var box = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>').addClass('dialog__box').appendTo(dlg);
  var heading = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<div></div>').addClass('dialog__box__heading').html(title).appendTo(box);
  ...
  if (finalOptions.closeButton) {
    var button = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<a></a>').attr('href', '#').attr('aria-label', 'Close').attr('role', 'button').addClass('dialog__box__heading__close').append(jquery__WEBPACK_IMPORTED_MODULE_0___default()('<span></span>').addClass('dialog__box__heading__close__icon'));
...
var className = 'filterDropdown'; // Global array to store selected country value

var selectedItems = []; // Push selected country value to global array

function itemSelect() {
  var item = document.getElementById('items-list');
  var selectedItem = item.options[item.selectedIndex].text; // Special characters to be removed
  ...
  selectedItem = selectedItem.replace(/[ ()]/g, function (m) {
    return chars[m];
  });
...
jquery__WEBPACK_IMPORTED_MODULE_2___default()('#items-list').change(function () {
  // Run function which builds array of all selected countries
  itemSelect(); // Last selected country from array
  // Add '#' to pair with matching ID in HTML

  var selectedItem = "#".concat(selectedItems.slice(-1)[0]); // Hide non-selected countries' data

  jquery__WEBPACK_IMPORTED_MODULE_2___default()('.data-group .data-specific').hide(); // Show selected country data. Don't show if user selects 'Select a country'

  if (selectedItem !== '#Selectacountry') {
    jquery__WEBPACK_IMPORTED_MODULE_2___default()('.data-group').find(selectedItem).fadeIn();
  }
});
...
function kisWidget(el) {
  var widget = jquery__WEBPACK_IMPORTED_MODULE_2___default()(el);
  var kisIframe = widget.find('#unistats-widget-frame');

  var update = function update() {
    var src = kisIframe.attr('src'),
        currentHorizontal = src.indexOf('horizontal') >= 0,
        neededHorizontal = jquery__WEBPACK_IMPORTED_MODULE_2___default()(window).width() > 635;
...
if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('body').is('[class*="scp"]')) {
...
function checkImage(linkImage) {
  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(linkImage).children('img').length) {
    return true;
  }
...
var COOKIE_NAME = 'mbapopup';
var USERNAME_COOKIE = 'CityUsername';
var ALWAYS_SHOW_TO = 'sbbh844'; // always pop up if Khus is logged in

var inOneYear = new Date(new Date().getTime() + 365 * 24 * 60 * 60 * 1000);

function launch(el) {
  var widget = jquery__WEBPACK_IMPORTED_MODULE_3___default()(el);
  var displayPopup = false;

  if (js_cookie__WEBPACK_IMPORTED_MODULE_4___default.a.get(USERNAME_COOKIE) && js_cookie__WEBPACK_IMPORTED_MODULE_4___default.a.get(USERNAME_COOKIE).match(new RegExp(ALWAYS_SHOW_TO))) {
    displayPopup = true;
  } else {
    if (!js_cookie__WEBPACK_IMPORTED_MODULE_4___default.a.get(COOKIE_NAME)) {
      js_cookie__WEBPACK_IMPORTED_MODULE_4___default.a.set(COOKIE_NAME, '0', {
        expires: inOneYear
      });
    } else {
      if (js_cookie__WEBPACK_IMPORTED_MODULE_4___default.a.get(COOKIE_NAME) === '0') {
        // && Math.random() <= 0.2) {
        js_cookie__WEBPACK_IMPORTED_MODULE_4___default.a.set(COOKIE_NAME, '1', {
          expires: inOneYear
        });
        displayPopup = true;
      }
  ...
  jquery__WEBPACK_IMPORTED_MODULE_3___default()('.mba-popup').click(function (e) {
    if (e.target !== this) return;
    jquery__WEBPACK_IMPORTED_MODULE_3___default()('.mba-popup').removeClass('open');
    e.preventDefault();
  });
  ...
  if (displayPopup) {
    jquery__WEBPACK_IMPORTED_MODULE_3___default()('.mba-popup').addClass('open');
  }
}

var className = 'mba-popup';
/* harmony default export */ __webpack_exports__["default"] = ({
  launch: launch,
  className: className
});
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _nav_mobile__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./nav-mobile */ "./src/components/nav-mobile/nav-mobile.js");
/* harmony import */ var _parse_nav__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./parse-nav */ "./src/components/nav-mobile/parse-nav.js");
...
function launch(el) {
  ...
  var nav = new _nav_mobile__WEBPACK_IMPORTED_MODULE_1__["default"](element, _parse_nav__WEBPACK_IMPORTED_MODULE_2__["tree"], _parse_nav__WEBPACK_IMPORTED_MODULE_2__["current"]);
  nav.launch();
}
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _vertical_menu_helper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vertical-menu-helper */ "./src/components/nav-mobile/vertical-menu-helper.js");
...
function () {
  function NavMobile(nav, tree, defaultOpen) {
    ...
    if (label.length > 0 && label.attr('for')) {
      this.toggle = jquery__WEBPACK_IMPORTED_MODULE_1___default()("#".concat(label.attr('for')));
    }
...
/* harmony import */ var _js_utils_scroll_to__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../js-utils/scroll-to */ "./src/js-utils/scroll-to.js");
/* harmony import */ var _js_utils_scrolled_into_view__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../js-utils/scrolled-into-view */ "./src/js-utils/scrolled-into-view.js");
...
function searchParams() {
  var params = ['dev', 'SQ_DESIGN_NAME', 'SQ_PAINT_LAYOUT_NAME'].map(function (key) {
    return {
      key: key,
      match: location.search.match(new RegExp("[?&]".concat(key, "=([^&]*)")))
    };
  }).filter(function (p) {
    return p.match;
  }).map(function (_ref) {
    var key = _ref.key,
        match = _ref.match;
    return "".concat(key, "=").concat(match[1]);
  });
...
function () {
  function VerticalMenuHelper(menuContainer, tree, defaultOpen, scroll) {
    ...
    if (tree) {
      ...
      this.tree = clone__WEBPACK_IMPORTED_MODULE_7___default()(tree);
      ...
      this.menuContainer.on('click', '[data-toggle]', function (evt) {
        toggleChildren(jquery__WEBPACK_IMPORTED_MODULE_6___default()(this).attr('data-toggle'));
        evt.preventDefault();
      });
    }
  }
  ...
  _createClass(VerticalMenuHelper, [{
    ...
    value: function toggleChildren(item) {
      ...
      if (item.children.length > 0) {
        ...
        if (this.scroll && Object(_js_utils_scrolled_into_view__WEBPACK_IMPORTED_MODULE_9__["default"])(item.element) < 1) {
          Object(_js_utils_scroll_to__WEBPACK_IMPORTED_MODULE_8__["default"])(item.element);
        }
      }
    ...
    value: function prepareItemElement(item) {
      if (!item.element) {
        var element = jquery__WEBPACK_IMPORTED_MODULE_6___default()('<div></div>');

        if (item.name) {
          element.addClass("vertical-menu vertical-menu--l".concat(item.level));
          var header = jquery__WEBPACK_IMPORTED_MODULE_6___default()('<div></div>').addClass('vertical-menu__header').appendTo(element);
          jquery__WEBPACK_IMPORTED_MODULE_6___default()('<a class="vertical-menu__page-link"></a>').addClass("vertical-menu__page-link--t".concat(item.type)).attr('href', item.url + this.searchQueryStr).append(jquery__WEBPACK_IMPORTED_MODULE_6___default()('<span class="vertical-menu__page-link__label"></span>').html(item.name)).appendTo(header);

          if (item.level > this.rootLevel && item.children.length > 0) {
            var childrenToggle = jquery__WEBPACK_IMPORTED_MODULE_6___default()('<a role="button" href="#" class="vertical-menu__toggle-link"><span class="fa" aria-hidden="true"></span></a>');
        ...
        if (item.children.length > 0) {
          item.childrenContainer = jquery__WEBPACK_IMPORTED_MODULE_6___default()('<ul></ul>').appendTo(item.element);
        }
      }
    }
  }]);
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _dialog_dialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../dialog/dialog */ "./src/components/dialog/dialog.js");
/* harmony import */ var _js_utils_variations__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../js-utils/variations */ "./src/js-utils/variations.js");
    ...
    if (children.length === 2) {
      ...
      if (heading.length > 0 && heading.prop('tagName').toLowerCase().match(/h[0-9]/)) {
        ...
        var categories = li.parentsUntil(widget).filter('[data-popup-def-list-category]').get().reverse().map(function (e) {
          return jquery__WEBPACK_IMPORTED_MODULE_3___default()(e).attr('data-popup-def-list-category');
        });
        items.push({
          li: li,
          heading: heading,
...
function prepareItems(widget, items) {
  var variations = Object(_js_utils_variations__WEBPACK_IMPORTED_MODULE_5__["identifyVariations"])(widget, className);
  ...
  var open = function open(i, identifyFocusBackTo) {
    ...
    var dlgTitle = jquery__WEBPACK_IMPORTED_MODULE_3___default()('<div></div>');

    if (category) {
      jquery__WEBPACK_IMPORTED_MODULE_3___default()('<div></div>').addClass('popup-def-list-group__dlg__title__small').html(category).appendTo(dlgTitle);
    }

    jquery__WEBPACK_IMPORTED_MODULE_3___default()('<div></div>').html(title).appendTo(dlgTitle);
    ...
    var prevLink = jquery__WEBPACK_IMPORTED_MODULE_3___default()('<a></a>').attr('href', '#').append(prev.title).on('click', function (evt) {
      evt.preventDefault();
      open(prevIndex, false);
    });
    var nextLink = jquery__WEBPACK_IMPORTED_MODULE_3___default()('<a></a>').attr('href', '#').append(next.title).on('click', function (evt) {
      evt.preventDefault();
      open(nextIndex, false);
    });
    var nextWrapper = jquery__WEBPACK_IMPORTED_MODULE_3___default()('<div></div>').addClass('popup-def-list-group__prevnext__next').append(nextLink).append('<span class="popup-def-list-group__prevnext__next__icon" aria-hidden="true"></span>');
    var prevWrapper = jquery__WEBPACK_IMPORTED_MODULE_3___default()('<div></div>').addClass('popup-def-list-group__prevnext__prev').append('<span class="popup-def-list-group__prevnext__prev__icon" aria-hidden="true"></span>').append(prevLink);
    var dlgContent = jquery__WEBPACK_IMPORTED_MODULE_3___default()('<div></div>').append(content);
    jquery__WEBPACK_IMPORTED_MODULE_3___default()('<div></div>').addClass('popup-def-list-group__prevnext').append(prevWrapper).append(nextWrapper).appendTo(dlgContent);
    Object(_dialog_dialog__WEBPACK_IMPORTED_MODULE_4__["openModalDialog"])(dlgTitle, dlgContent, {
      identifyFocusBackTo: identifyFocusBackTo,
      className: Object(_js_utils_variations__WEBPACK_IMPORTED_MODULE_5__["variationClassNames"])("".concat(className, "__dlg"), variations)
    });
  };

  items.forEach(function (_ref, i) {
    var heading = _ref.heading;
    var anchor = jquery__WEBPACK_IMPORTED_MODULE_3___default()('<a></a>').attr('href', '#').addClass('popup-def-list-group__anchor').html(heading.html());
  ...
  widget.on('change', 'select', function () {
    ...
    if (secondary) {
      ...
      secondaryItems.forEach(function (item, index) {
        var $secondaryElement = jquery__WEBPACK_IMPORTED_MODULE_2___default()('.primary-dropdown-secondary-' + (index + 1));

        if ($secondaryElement.hasClass('primary-dropdown-fade')) {
          $secondaryElement.fadeOut(function () {
            jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).text(secondaryItems[index]).fadeIn(fadeTime);
          });
        } else {
...
/* harmony import */ var _js_utils_browser_support__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../js-utils/browser-support */ "./src/js-utils/browser-support.js");
/* harmony import */ var _launch_animation__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./launch-animation */ "./src/components/scroll-animations/launch-animation.js");
...
function launch(el) {
  if (_js_utils_browser_support__WEBPACK_IMPORTED_MODULE_9__["default"].intersectionObserver) {
    var widget = jquery__WEBPACK_IMPORTED_MODULE_8___default()(el);
    ...
    _launch_animation__WEBPACK_IMPORTED_MODULE_10__["launchAnimation"].apply(void 0, [widget].concat(_toConsumableArray(types)));
  }
}
...
/* harmony import */ var extend__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! extend */ "./node_modules/extend/index.js");
/* harmony import */ var extend__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(extend__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _action_on_scroll__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../action-on-scroll */ "./src/components/action-on-scroll.js");
/* harmony import */ var _js_utils_browser_support__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../js-utils/browser-support */ "./src/js-utils/browser-support.js");
/* harmony import */ var _animation_types__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./animation-types */ "./src/components/scroll-animations/animation-types.js");
...
function getAnimData(prevData, element) {
  ...
  bases.forEach(function (base) {
    var regex = new RegExp("^data-".concat(base, "-(.+)$"));
  ...
  return prevData ? extend__WEBPACK_IMPORTED_MODULE_8___default()({}, prevData, data) : data;
}
...
function launchAnimation(widget) {
  ...
  var anims = types.filter(function (type) {
    return _animation_types__WEBPACK_IMPORTED_MODULE_11__["default"][type];
  }).map(function (type) {
    var anim = _animation_types__WEBPACK_IMPORTED_MODULE_11__["default"][type];
    var isFunction = typeof anim === 'function';
    var func = isFunction ? anim : anim.run;
    var typeParams = getAnimData(widgetParams, widget, "anim-".concat(type));
    var targets = typeParams.target ? jquery__WEBPACK_IMPORTED_MODULE_7___default.a.makeArray(widget.find(".".concat(typeParams.target))).map(function (targetEl) {
      var target = jquery__WEBPACK_IMPORTED_MODULE_7___default()(targetEl);
      return {
        target: target,
        params: getAnimData(typeParams, target, 'anim', "anim-".concat(type))
      };
    }) : [{
      target: widget,
      params: typeParams
  ...
  if (anims.length > 0) {
    ...
    if (_js_utils_browser_support__WEBPACK_IMPORTED_MODULE_10__["default"].intersectionObserver) {
      Object(_action_on_scroll__WEBPACK_IMPORTED_MODULE_9__["default"])(widget, runAnimations);
    } else {
      runAnimations();
    }
  }
...
/* harmony import */ var core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/modules/es6.array.find */ "./node_modules/core-js/modules/es6.array.find.js");
/* harmony import */ var core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_array_find__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _js_utils_request_anim_frame__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../js-utils/request-anim-frame */ "./src/js-utils/request-anim-frame.js");
  ...
  if (value !== 0) {
    ...
    var f = function f(timestamp) {
      ...
      if (finish) {
        ...
        Object(_js_utils_request_anim_frame__WEBPACK_IMPORTED_MODULE_3__["default"])(f);
      }
    };
...
function initSvgPathAnimation(path) {
  if (path[0] && typeof path[0].getTotalLength === 'function') {
    ...
    path.css({
      ...
      'stroke-dasharray': "".concat(length, ", ").concat(length)
    });
    return true;
  }
...
function launch(el) {
  var widget = jquery__WEBPACK_IMPORTED_MODULE_4___default()(el);
...
/***/ "./src/components/soundwave-bg/soundwave-bg.js":
/*!*****************************************************!*\
  !*** ./src/components/soundwave-bg/soundwave-bg.js ***!
  \*****************************************************/
/*! exports provided: default */
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var sine_waves__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! sine-waves */ "./node_modules/sine-waves/sine-waves.js");
/* harmony import */ var sine_waves__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(sine_waves__WEBPACK_IMPORTED_MODULE_1__);
...
function launch(el) {
  var waves = new sine_waves__WEBPACK_IMPORTED_MODULE_1___default.a({
    el: document.getElementById('waves'),
    speed: 4,
    width: function width() {
      return jquery__WEBPACK_IMPORTED_MODULE_0___default()('#waves').width();
    },
    height: function height() {
      return jquery__WEBPACK_IMPORTED_MODULE_0___default()('#waves').height();
    },
    ease: 'SineInOut',
    wavesWidth: '70%',
    waves: [{
    ...
    resizeEvent: function resizeEvent() {
      ...
      gradient.addColorStop(0.3, '#ffffff30');
...
function launch(el) {
  var widget = jquery__WEBPACK_IMPORTED_MODULE_10___default()(el);
  ...
  var anchor = jquery__WEBPACK_IMPORTED_MODULE_10___default()('<a></a>').addClass("url-slide url-slide--".concat(direction)).attr('href', other.url).appendTo(widget);
  jquery__WEBPACK_IMPORTED_MODULE_10___default()('<div></div>').append(jquery__WEBPACK_IMPORTED_MODULE_10___default()('<span></span>').addClass('url-slide__current').html(current.name)).append(jquery__WEBPACK_IMPORTED_MODULE_10___default()('<span></span>').addClass('url-slide__icon')).append(jquery__WEBPACK_IMPORTED_MODULE_10___default()('<span></span>').addClass('url-slide__next').html(other.name)).appendTo(anchor);
}
...
function launch(el) {
  ...
  playButton.addClass('video-banner__play');
  playButton.append(jquery__WEBPACK_IMPORTED_MODULE_1___default()('<span></span>').addClass('video-banner__play__icon'));
...
var className = 'video-banner'; // Variables

var youtube_container = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.youtube-embed-container');
var youtube_video = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.youtube-embed-container iframe');
var youtube_video_src = youtube_video.attr('src');
var youtube_cta = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.video-cta');
var banner_image = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.image-banner');
var promo_cards = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.section--lightgray.promo-card__wrapper.left-box');
var promo_card_wrapper = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.section--lightgray.promo-card__wrapper.left-box');
var promo_card_white = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.section--lightgray.promo-card__wrapper.left-box .promo-cta.promo-cta--white.promo-cta--normal');
var top_card_grid = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.grid__6:first-of-type');
jquery__WEBPACK_IMPORTED_MODULE_1___default()(youtube_cta).click(function () {
  // Remove MP4 video banner
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.video-banner__banner').remove();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(window).resize(function () {
    ...
    if (windowWidth > 500 && windowWidth < 900) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()('.section--lightgray .promo-card--left .promo-cta.promo-cta--white').css({
        'margin-top': '15px',
        position: 'relative'
      });
...
/* harmony import */ var _video_preview_youtube__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./video-preview-youtube */ "./src/components/video-preview/video-preview-youtube.js");
...
function loadVideo(wrapper, service) {
  switch (service.type) {
    case 'youtube':
      return Object(_video_preview_youtube__WEBPACK_IMPORTED_MODULE_3__["default"])(wrapper, service);
...
/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom.iterable */ "./node_modules/core-js/modules/web.dom.iterable.js");
/* harmony import */ var core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_iterable__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _polyfills_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./polyfills.js */ "./src/polyfills.js");
/* harmony import */ var _plugins_plugins__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./plugins/plugins */ "./src/plugins/plugins.js");
/* harmony import */ var _plugins_plugins__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_plugins_plugins__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _component_list__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./component-list */ "./src/component-list.js");
/* harmony import */ var _components_linkIcons_linkIcons_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/linkIcons/linkIcons.js */ "./src/components/linkIcons/linkIcons.js");
/* harmony import */ var _components_video_preview_video_wrap_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/video-preview/video-wrap.js */ "./src/components/video-preview/video-wrap.js");
...
function launchPattern(pattern) {
  if (typeof pattern === 'function') {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_3___default()(".".concat(className, ":not(.").concat(className, "-njs)")).each(function () {
      var _this = this;
...
jquery__WEBPACK_IMPORTED_MODULE_3___default()(function () {
  return _component_list__WEBPACK_IMPORTED_MODULE_4__["default"].forEach(launchPattern);
});
...
function getDataAttributes(node) {
  var attrs = {};
  jquery__WEBPACK_IMPORTED_MODULE_2___default.a.each(node[0].attributes, function (index, attribute) {
...
function variationClassNames(className, variations) {
  return [className].concat(_toConsumableArray(variations.map(function (v) {
    return "".concat(className, "--").concat(v);
  }))).join(' ');
}
