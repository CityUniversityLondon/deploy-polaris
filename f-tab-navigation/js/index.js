...
/* harmony import */ var core_js_modules_es6_string_anchor__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! core-js/modules/es6.string.anchor */ "./node_modules/core-js/modules/es6.string.anchor.js");
/* harmony import */ var core_js_modules_es6_string_anchor__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es6_string_anchor__WEBPACK_IMPORTED_MODULE_5__);
...
/* harmony import */ var _js_utils_scrolled_above_view__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../js-utils/scrolled-above-view */ "./src/js-utils/scrolled-above-view.js");
...
function genActivateItem(widget, headingAnchors, allAnchors) {
  return function (id, scroll) {
    ...
    if (scroll === 'accordion' && Object(_js_utils_scrolled_above_view__WEBPACK_IMPORTED_MODULE_8__["default"])(heading)) {
      Object(_js_utils_scroll_to__WEBPACK_IMPORTED_MODULE_7__["default"])(heading);
    } else if (scroll === 'tab' && Object(_js_utils_scrolled_above_view__WEBPACK_IMPORTED_MODULE_8__["default"])(widget)) {
      Object(_js_utils_scroll_to__WEBPACK_IMPORTED_MODULE_7__["default"])(widget);
    }
  };
}
...
function prepareLinks(widget, headings) {
  ...
  if (menu) {
    ...
    menuAnchors.on('keydown', function (evt) {
      var moveTo = -1;
      var anchor = jquery__WEBPACK_IMPORTED_MODULE_6___default()(this);
  ...
  } // Modify markup if anchor selected
  ...
  try {
    for (var _iterator = elements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      // Unformatted anchor text value
      var textVal = element.textContent; // Formatted anchor text value

      var formattedTextVal = textVal.replace(/\s+/g, '-').toLowerCase(); // Pass formatted value to element ID
  ...
  allAnchors.on('click', function (evt) {
    ...
    var targetTabHeadings = document.getElementsByClassName('accordion-tabs__content__heading');
    var _iteratorNormalCompletion2 = true;
    var _didIteratorError2 = false;
    var _iteratorError2 = undefined;

    try {
      for (var _iterator2 = targetTabHeadings[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        var targetTabHeading = _step2.value;
        // Unformatted heading text value
        var targetTabHeadingText = targetTabHeading.textContent; // Formatted heading text value

        var formattedTextVal = targetTabHeadingText.replace(/\s+/g, '-').toLowerCase();
        console.log(formattedTextVal);
    ...
    var anchor = jquery__WEBPACK_IMPORTED_MODULE_6___default()(this); // anchor.id = 'test';
...
/* harmony import */ var _element_classnames__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./element-classnames */ "./src/components/accordion-tabs/common/element-classnames.js");
...
function prepareAccordionHeading(patternClassname, text, id) {
  var anchor = jquery__WEBPACK_IMPORTED_MODULE_5___default()('<a/>').addClass("".concat(Object(_element_classnames__WEBPACK_IMPORTED_MODULE_6__["headingAnchorCn"])(patternClassname), " inactive")).attr('href', '#').attr('data-id', id).attr('data-accordion-anchor', true);
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('<span/>').html(text).addClass(Object(_element_classnames__WEBPACK_IMPORTED_MODULE_6__["headingAnchorLabelCn"])(patternClassname)).appendTo(anchor);
  jquery__WEBPACK_IMPORTED_MODULE_5___default()('<span/>').attr('aria-hidden', 'true').addClass(Object(_element_classnames__WEBPACK_IMPORTED_MODULE_6__["headingAnchorIconCn"])(patternClassname)).appendTo(anchor);
  return anchor;
}

function findHeadings(className, widget, contentWrapper) {
  var firstHeading = contentWrapper.find('h2,h3,h4'); // console.log(firstHeading);

  var headingTagName = firstHeading.prop('tagName'); // console.log(headingTagName);

  var headerElements = contentWrapper.find(headingTagName); // console.log(headerElements);

  return headerElements.toArray().map(function (element, i) {
    var header = jquery__WEBPACK_IMPORTED_MODULE_5___default()(element).attr('data-id', i).addClass(Object(_element_classnames__WEBPACK_IMPORTED_MODULE_6__["headingCn"])(className)); //  e.g. h3.tabs__content__heading, h2.accordion-tabs__content__heading
    //  console.log(header);

    var parents = header.parentsUntil(contentWrapper); // console.log(parents);
    ...
    if (!wrapper) {
      ...
      wrapper = jquery__WEBPACK_IMPORTED_MODULE_5___default()('<div></div>').insertBefore(header).append(header).append(contentElements);
    }

    wrapper.addClass(Object(_element_classnames__WEBPACK_IMPORTED_MODULE_6__["contentGroupCn"])(className));
    var anchor = prepareAccordionHeading(className, header.html(), i);
    anchor.insertBefore(wrapper); // New

    var elems = document.querySelectorAll(".accordion-tabs__menu__item__label");
    var _iteratorNormalCompletion = true;
    var _didIteratorError = false;
    var _iteratorError = undefined;
...
function launch(el) {
  var link = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.carousel__control__button__link');
  link.each(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).click(function (e) {
      e.preventDefault();
      var buttonID = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('button');
