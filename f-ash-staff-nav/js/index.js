...
function prepareMenu(widget) {
  ...
  if (_parse_nav__WEBPACK_IMPORTED_MODULE_2__["currentURL"].includes('bayes.city.ac.uk/staff-hub')) {
    const menu = new _nav_mobile_vertical_menu_helper__WEBPACK_IMPORTED_MODULE_3__["default"](container, _parse_nav__WEBPACK_IMPORTED_MODULE_2__["tree"], _parse_nav__WEBPACK_IMPORTED_MODULE_2__["current"], false, 14); // Staffhub(SH) uses different tree due to being type2 asset in Matrix
    menu.launch();
  } else if (_parse_nav__WEBPACK_IMPORTED_MODULE_2__["currentURL"].includes('bayes.city.ac.uk/alumni')) {
    const menu = new _nav_mobile_vertical_menu_helper__WEBPACK_IMPORTED_MODULE_3__["default"](container, _parse_nav__WEBPACK_IMPORTED_MODULE_2__["tree"], _parse_nav__WEBPACK_IMPORTED_MODULE_2__["current"], false, 14); // Alumni uses different tree due to being type2 asset in Matrix
    menu.launch();
  } else {
